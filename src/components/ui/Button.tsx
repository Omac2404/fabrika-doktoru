 ...
 */
const base =
  'group/btn relative inline-flex items-center justify-center gap-2.5 rounded-md font-semibold tracking-tight transition-all duration-300 disabled:opacity-60 disabled:pointer-events-none';
...
const variants: Record<Variant, string> = {
  ...
  accent:
    'bg-accent-600 text-white shadow-lg shadow-brand-900/20 hover:bg-accent-500 hover:shadow-xl hover:shadow-brand-900/25',
  outline:
